 ...
 */
util.setQuerystringParams = function(date, assistant, bairro, bairroName, tabz, tabzName, houseGroup, camo) {
    ...
    if (bairroName) {
        adaptProps['bairroName'] = bairroName;
    }
    if (tabz) {
        adaptProps['tabz'] = tabz;
    }  
    if (tabzName) {
        adaptProps['tabzName'] = tabzName;
    }  
    if (houseGroup) {
